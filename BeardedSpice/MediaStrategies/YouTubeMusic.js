...
//  Modified by Roman Sokolov on 06/06/21
...
BSStrategy = {
  ...
  favorite: function() {
    document.querySelector('ytmusic-player-bar ytmusic-like-button-renderer .ytmusic-like-button-renderer.like').click()
  },
  trackInfo: function() {
    ...
    let like = document.querySelector('ytmusic-player-bar ytmusic-like-button-renderer');
